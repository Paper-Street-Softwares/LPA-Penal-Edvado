        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-2">
          <div
            className={`flex flex-col z-20 relative  ${
              isScrolled
                ? 'w-[30%] tablet1:w-[20%] tablet2:w-[30%] desktop1:w-[20%] desktop3:w-[15%] transition-all duration-700'
                : 'w-[50%] tablet1:w-[40%] tablet2:w-[50%] desktop1:w-[25%] desktop3:w-[20%] transition-all duration-700'
            }`}
          >
            {' '}
            <img
