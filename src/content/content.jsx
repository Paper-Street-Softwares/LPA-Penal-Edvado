...
const content = {
  texts: {
    ...
    hero: {
      miniTag: 'ADVOGADO TRABALHISTA',
      FirstPartTitle: 'Precisa de um Advogado',
      DestaquePartTitle: (
        <p>
          <span className="italic relative inline-block">Trabalhista</span>
        </p>
      ),
      SecondPartTitle: '?',
      subtitle: (
        <p>
          Dr. Edvaldo Costa Gomes é Especialista em Direito Trabalhista e
          Direito Processual Trabalhista, com grande experiência em todo o
          Brasil.
        </p>
      ),
      ...
      ctaButtonText: 'Falar com o Dr. Edvaldo Costa Gomes',
    ...
    features: {
      ...
      subtitle:
        'Excelência técnica na defesa de interesses e na conformidade das relações de trabalho.',
      imgFeatures: imgFeatures,
      alt: 'imagem representativa da Seção Serviços',
      titleMessageFeature: '100%',
      subtitleMessageFeature: 'defesa dos interesses',
      cards: {
        card1: {
          title: (
            <p>
              <i>Compliance</i> e Auditoria Trabalhista
            </p>
          ),
          subtitle:
            'Prevenção de riscos e adequação legal para evitar passivos.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card2: {
          title: 'Defesa em Reclamações Trabalhistas (Contencioso)',
          subtitle: 'Defesa estratégica em processos e redução de condenações.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card3: {
          title: 'Assessoria em Negociações Coletivas',
          subtitle: 'Acordos com sindicatos e flexibilização de normas.',
          description: (
            <div>
              A_Definir <br />
              <br />
        ...
        card4: {
          title: 'Gestão de Terceirização e Contratos Especiais',
          subtitle:
            'Segurança jurídica na contratação de terceiros e autônomos.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card5: {
          title: <p>Segurança e Saúde do Trabalho (SST)</p>,
          subtitle: 'Gestão de normas regulamentadoras e prevenção de multas.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card6: {
          title: 'Planejamento de Remuneração e Benefícios',
          subtitle: 'Estruturação de bônus e benefícios com eficiência fiscal.',
          description: (
            <div>
              A_Definir
              <br />
    ...
    ctaSecondary: {
      ...
      title: <h1>Seu patrimônio e sua tranquilidade são prioridades.</h1>,
      subtitle:
        'Riscos e conflitos trabalhistas exigem intervenção técnica imediata. Entre em contato para um diagnóstico estratégico e retome o controle da sua segurança jurídica agora.',
      subtitleDireita: (
    ...
    steps: {
      ...
      title: (
        <h1>
          Como
          <span className="destaque italic font-light"> efetuamos</span> a sua
          defesa?
        </h1>
      ),
      subtitle: '',
      ...
      cards: {
        card1: {
          ...
          cardDescription:
            'Análise imediata da situação contratual ou processual para estancar riscos e definir a melhor linha de ação.',
        },
        card2: {
          stepNumber: 2,
          cardTitle: 'Saneamento de Provas',
          cardDescription:
            'Exame rigoroso de documentos, registros e rotinas, identificando pontos críticos e fortalecendo o conjunto probatório.',
        },
        card3: {
          stepNumber: 3,
          cardTitle: 'Construção da Tese',
          cardDescription:
            'Desenvolvimento de fundamentação jurídica personalizada, focada na neutralização de pedidos e na eficiência econômica.',
        },
        card4: {
          stepNumber: 4,
          cardTitle: 'Representação Decisiva',
          cardDescription:
            'Atuação técnica e incisiva em audiências e tribunais, priorizando acordos vantajosos ou o êxito em decisões judiciais.',
        },
      },
    },
    // blog: {
    ...
    faq: {
      ...
      questions: {
        question1: {
          question:
            'Como reduzir o risco de processos trabalhistas na minha empresa?',
          answer:
            'O primeiro passo é reunir provas (mensagens, extratos, fotos) e buscar análise jurídica imediata. Você tem o direito de cobrar não apenas as verbas rescisórias, mas também multas pelo atraso no pagamento e eventuais direitos que foram negados durante o contrato.',
        },
        question2: {
          question:
            'Sofro assédio ou condições abusivas, mas ainda estou trabalhando. Posso processar?',
          answer:
            'Sim. Existe a figura da Rescisão Indireta, que é como uma "justa causa aplicada ao patrão". Se a empresa descumpre o contrato ou cria um ambiente hostil, você pode buscar a saída da empresa recebendo todos os seus direitos como se tivesse sido demitido sem justa causa.',
        },
        question3: {
          question:
            'Trabalhei sem carteira assinada. Ainda tenho direitos trabalhistas?',
          answer:
            'Com certeza. Se você cumpria ordens, recebia salário e tinha horários, o vínculo de emprego existe legalmente. Podemos ingressar com uma ação para reconhecimento de vínculo, garantindo o pagamento retroativo de FGTS, férias, 13º e todas as proteções da lei.',
        },
        question4: {
          question:
            'Qual é o prazo máximo para entrar com uma ação trabalhista?',
          answer:
            'No Brasil, o prazo é de 2 anos após a saída da empresa. No entanto, você só pode cobrar os direitos referentes aos últimos 5 anos contados da data em que entrar com o processo. Por isso, a demora em buscar ajuda pode significar a perda definitiva de dinheiro.',
        },
      },
